            ...
            <main>
                ...
                <section id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="newtrainee1.html">Personal Details</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <form action="newtrainee2.php" method="post" class="col-md-7 col-md-offset-4"  id="newtrainee1" >			    
                            <div class="form-group row">
                                <i class="fa fa-user fa-lg prefix black-text col-1 col-form-label"></i>
                                <div class="col-5">
                            ...
                            <div class="form-group row">
                                <i class="fa fa-envelope fa-lg prefix black-text col-1 col-form-label"></i>
                                <div class="col-7">
                                    <input type="email" id="email" class="form-control" name="email" required placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group row">
                                <i class="fa fa-id-card fa-lg prefix black-text col-1 col-form-label"></i>
                                <div class="col-5">
                                    <input type="text" id="id" class="form-control" name="id" required placeholder="ID">
                                </div>
                            </div>
                            <div class="form-group row">
                                <i class="fa fa-phone fa-lg prefix black-text col-1 col-form-label"></i>
                                <div class="col-5">
                                    <input type="tel" id="tel" class="form-control" name="phone" required placeholder="Phone Number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <i class="fa fa-calendar fa-lg prefix black-text col-1 col-form-label"></i>
                                <div class="col-4">
                                    <input type="date" id="date" class="form-control" name="date" required placeholder="Birth Date">
                                </div>
                            </div>
                            <div class="form-group row">
                                <i class="fa fa-user-circle fa-lg prefix black-text col-1 col-form-label"></i>
                                <div class="col-5">
                                    <input type="text" id="user_name" class="form-control" name="user_name" required placeholder="User Name">
                                </div>
                            </div>

                            <div class="text-center formbuttons" >
                                <a href="trainerdashboard.php" class="btn btn-warning">Back</a>
